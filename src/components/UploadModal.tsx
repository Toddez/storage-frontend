        ...
        return (
            <div className='Modal' onClick={this.handleClick}>
                <form className='modal-content' onSubmit={(data) => { this.handleSubmit(data); this.props.hide(); }}>
                    <input type="file" multiple name="file" id="file" onChange={this.handleFileChange} required />
                    <label htmlFor="file" className='input-border'><UploadIcon /><span>{this.labelText()}</span></label>
